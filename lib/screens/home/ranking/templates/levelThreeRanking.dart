...
class LevelThreeRanking extends StatefulWidget {
  @override
  _LevelThreeRankingState createState() => _LevelThreeRankingState();
}

class _LevelThreeRankingState extends State<LevelThreeRanking> {
  ...
  Widget build(BuildContext context) {
    ...
    _users.sort((a, b) => a.levelThreeTime.compareTo(b.levelThreeTime));
            ...
            rows: List<DataRow>.generate(
              ...
              (index) => DataRow(cells: [
                ...
                DataCell(rankingItems[index] != null
                    ...
                    : Text("Guest")),
                DataCell(rankingItems[index] != null
                    ? Text(rankingItems[index].levelThreeTime.toString())
                    : Text("1:00:00")),
                DataCell(rankingItems[index] != null
                    ? Image(
